...
public class YearsAndAnnualSalaries {
    public static void main(String[] args) {
        /*Write a program to ask user to enter numbers of worked years and annual salary. If user worked for more
        or equals to 5 years than user is eligible for the bonus, otherwise he is not. Once user is eligible and
        ...
        if (salary>50000) System.out.println("Your bonus 5000");
